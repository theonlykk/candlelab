                                    ...
                                    html.Tr([
                                        html.Td("Instrument",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("FX pair. Base currency / Quote currency (e.g. EUR_AUD = Euro vs Australian Dollar).",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("Setup",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("Candlestick pattern combination. 'hammer + nan' = hammer pattern, no continuation filter. 'engulfing + inside_bar' = engulfing pattern confirmed by inside bar.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("Dir",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("Trade direction. Long = buy the base currency. Short = sell it.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("T/O",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("Timeout in M30 bars. Maximum holding period if neither stop loss nor take profit is hit. 20 = ~10h, 40 = ~20h, 60 = ~30h, 96 = ~48h.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("SQN",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("System Quality Number. Mean R-multiple / Std R-multiple × √trades. Above 0.8 = minimum threshold. Above 1.0 = good edge. Above 2.0 = strong edge. Very high values (e.g. 1680) with few trades = degenerate combo, disregard.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("Mean R",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("Average profit per trade as a multiple of risk. 1.0 = made back exactly what was risked on average. 2.0 = made 2× risk on average.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("Trades",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("Total out-of-sample trades across all promoted windows. Minimum 5 required. Fewer than 10 = treat with caution.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("Windows",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("Number of rolling 4-week out-of-sample windows where this setup was profitable (out of 27 total). Higher = more consistent across time. V8 maximum is 4.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("NQS",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("Neighbourhood Quality Score. Measures robustness across similar parameter settings. 0.00 = RED_THIN (not enough similar combos to validate). Blank = below minimum window threshold, not scored.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("Status",
                                                style={"padding": "6px 12px",
                                                       ...
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("GREEN = deployable edge. RED_THIN = insufficient neighbours to validate. RED_STALE = not promoted in last 5 windows. RED_WEAK_SQN = SQN below 0.8. RED_SPIKE = SQN suspiciously above neighbours. Blank = below minimum threshold.",
                                                style={"padding": "6px 12px",
                                                       "borderBottom": "1px solid #f0f0f0"}),
                                    ]),
                                    html.Tr([
                                        html.Td("Recency",
                                                style={"padding": "6px 12px",
                                                       "fontWeight": "600",
                                                       "whiteSpace": "nowrap"}),
                                        html.Td("27-cell barcode. Each cell = one 4-week OOS window. Dark = promoted that window. The last 5 cells (right, blue background) = recency zone. A GREEN candidate must have at least one dark cell in the recency zone.",
                                                style={"padding": "6px 12px"}),
                                    ]),
                                ]),
                            ],
