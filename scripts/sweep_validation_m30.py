...
PAIR_CONFIG = {
    ...
    "GBP_AUD": {"ma_pairs": [(10, 50)], "timeouts": [40], "directions": ["long", "short"], "sl_mode": "atr_only", "enabled": True},
...
OUTPUT_DIR = r"d:\candlelab\scripts\output\m30"
ROSTER_FILE = r"d:\candlelab\scripts\output\m30\deployment_roster.json"
...
def fetch_instrument_data(instrument: str, conn) -> pd.DataFrame:
    """Load M30 candles from oanda_candles; mid OHLC from bid/ask for signal logic."""
    sql = """
