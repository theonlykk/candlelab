...
PAIR_CONFIG = {
    ...
    "GBP_AUD": {"ma_pairs": [(10, 50)], "timeouts": [80], "directions": ["long", "short"], "sl_mode": "standard", "enabled": True},
...
OUTPUT_DIR = r"d:\candlelab\scripts\output\ftmo_m15"
import os as _os
_os.makedirs(OUTPUT_DIR, exist_ok=True)
ROSTER_FILE = r"d:\candlelab\scripts\output\ftmo_m15\deployment_roster.json"
...
def fetch_instrument_data(instrument: str, conn) -> pd.DataFrame:
    """Load M15 candles from ftmo_candles with real measured spread_points."""
    sql = """
